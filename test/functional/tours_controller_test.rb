...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { desc: @tour.desc, finalized: @tour.finalized, number: @tour.number, user_biography_id: @tour.user_biography_id }
    end
  ...
  test "should update tour" do
    put :update, id: @tour, tour: { desc: @tour.desc, finalized: @tour.finalized, number: @tour.number, user_biography_id: @tour.user_biography_id }
    assert_redirected_to tour_path(assigns(:tour))
  end
